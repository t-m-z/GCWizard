...
List<Map<String, Object?>> _inputsMathToExpected = [
  ...
  {'code' : 'print TRUNC(-2.6, 5)', 'expectedOutput' : '-2', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print TRUNC( )', 'expectedOutput' : '0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print GGT( )', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print GGT(3 )', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print KGV( )', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print KGV(3 )', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print SIN(-2.6, 5)', 'expectedOutput' : '-0.5155013718214642', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print SIN( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print ASIN(PI/2)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ASIN(1.570796327)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ASIN(-2)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ASIN(-2.6)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ASIN(-2.6, 5)', 'expectedOutput' : 'NaN', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print ASIN( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print ASIN(X)', 'expectedOutput' : '0.0'},

  {'code' : 'print COS(0)', 'expectedOutput' : '1.0'},
  {'code' : 'print COS(PI/2)', 'expectedOutput' : '6.123233995736766e-17'},
  ...
  {'code' : 'print COS(-2.6, 5)', 'expectedOutput' : '-0.8568887533689473', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print COS( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print COS(X)', 'expectedOutput' : '1.0'},

  {'code' : 'print ACOS(0)', 'expectedOutput' : '1.5707963267948966'},
  {'code' : 'print ACOS(PI/2)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ACOS(1.570796327)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ACOS(-2)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ACOS(-2.6)', 'expectedOutput' : 'NaN'},
  {'code' : 'print ACOS(-2.6, 5)', 'expectedOutput' : 'NaN', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print ACOS( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print ACOS(X)', 'expectedOutput' : '1.5707963267948966'},

  {'code' : 'print TAN(0)', 'expectedOutput' : '0.0'},
  {'code' : 'print TAN(PI/2)', 'expectedOutput' : '16331239353195370.0'},
  ...
  {'code' : 'print TAN(-2.6, 5)', 'expectedOutput' : '0.6015966130897586', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print TAN( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print TAN(X)', 'expectedOutput' : '0.0'},

  {'code' : 'print ATAN(0)', 'expectedOutput' : '0.0'},
  {'code' : 'print ATAN(PI/2)', 'expectedOutput' : '1.0038848218538872'},
  ...
  {'code' : 'print ATAN(-2.6, 5)', 'expectedOutput' : '-1.2036224929766774', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print ATAN( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print EXP(-2.6, 5)', 'expectedOutput' : '0.07427357821433388', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print EXP( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print LOG(-2.6, 5)', 'expectedOutput' : 'NaN', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print LOG( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print LN(-2.6, 5)', 'expectedOutput' : 'NaN', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print LN( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print SQRT(-2.6, 5)', 'expectedOutput' : 'NaN', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print SQRT( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print DEG(-2.6, 5)', 'expectedOutput' : '-148.96902673401405', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print DEG( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print RAD(-2.6, 5)', 'expectedOutput' : '-0.04537856055185257', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print RAD( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print RAD(X)', 'expectedOutput' : '0.0'},

  {'code' : 'print RND(0)', 'expectedOutput' : '0.0'},
  //{'code' : 'print RND(-2.6, 5)', 'expectedOutput' : '0.3808527102296132', 'error': 'gcwizard_script_unbalanced_parentheses'},
  // it is not feasible to tes a random generated number
  {'code' : 'print RND( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print CEIL(-2.6, 5)', 'expectedOutput' : '-2', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print CEIL( )', 'expectedOutput' : '0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print FLOOR(-2.6, 5)', 'expectedOutput' : '-3', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print FLOOR( )', 'expectedOutput' : '0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print QSUM(-2.6, 5)', 'expectedOutput' : '8', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print QSUM( )', 'expectedOutput' : '0', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print IQSUM(-2.6, 5)', 'expectedOutput' : '8', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print IQSUM( )', 'expectedOutput' : '0', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print IQSUM(X)', 'expectedOutput' : '0'},

  {'code' : 'print CONVERTBASE("42.42", 10, 2)', 'expectedOutput' : '101010.01101011100001010001111010111000010100011110101110'},
  {'code' : 'print CONVERTBASE("42.42", 10, 3)', 'expectedOutput' : '1120.10210001121201222110102100011212012200021021220011'},
  {'code' : 'print CONVERTBASE("42.42", 10, 4)', 'expectedOutput' : '222.122320110132232011013223201'},
  {'code' : 'print CONVERTBASE("42.42", 10, 5)', 'expectedOutput' : '132.20222222222222222222222323441102400343013402001133'},
  {'code' : 'print CONVERTBASE("42.42", 10, 6)', 'expectedOutput' : '110.23041530415304153041533020313211140055225054411010'},
  {'code' : 'print CONVERTBASE("42.42", 10, 7)', 'expectedOutput' : '60.26402640264026402640351514150053441365564663223526'},
  {'code' : 'print CONVERTBASE("42.42", 10, 8)', 'expectedOutput' : '52.327024365605075341'},
