...
''';
    ...
    List<Map<String, Object?>> _inputsToExpected = [
      ...
      {'input' : test2, 'positions' : '1.2 2.1', 'searchFormat' : searchFormat.SectionCharacter, 'expectedOutput' : 'BO', 'spacesOn' : false, 'emptyLinesOn' : true, 'ignoreSymbols' : '.;+-:!?\'"‘&(){}[]/\\', 'diacriticsOn' : true, 'azOn' : true, 'numbersOn' : true, 'onlyFirstWordLetter' : false},
