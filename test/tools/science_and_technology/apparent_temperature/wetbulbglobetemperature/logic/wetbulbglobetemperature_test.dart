...
void main() {
  DateTimeTZ _currentDateTime =
      DateTimeTZ(dateTimeUtc: DateTime(2022, 07, 01, 12, 00, 00), timezone: const Duration(hours: -5));
    ...
    for (var elem in _inputsToExpected) {
      test('temperature: ${elem['temperature']}, humidity: ${elem['humidity']}', () {
        var _actual = calculateWetBulbGlobeTemperature(
          year: _currentDateTime.dateTimeUtc.year,
          month: _currentDateTime.dateTimeUtc.month,
          day: _currentDateTime.dateTimeUtc.day,
          hour: _currentDateTime.dateTimeUtc.hour,
          minute: _currentDateTime.dateTimeUtc.minute,
          ...
          temperature: elem['temperature'] as double,
          humidity: elem['humidity'] as double,
