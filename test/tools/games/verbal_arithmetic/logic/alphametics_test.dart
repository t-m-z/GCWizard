...
void main() {
  ...
  group("Alphametics.solveAlphametic:", () {
    ...
    List<Map<String, Object?>> _inputsToExpected = [
      ...
      {'input' : ['SEND+MORE=MONEY'], 'advancedInput' : 'N [EM] [MD-O].[RSY] E [R] [YS.NOR]', 'expectedOutput' : '9567+1085=10652', 'advancedOutput' : 'N 51 17.892 E 8 29.608'},
    ...
    for (var elem in _inputsToExpected) {
      test('formulas: ${elem['input']}', () {
        ...
        var advancedInput = elem['advancedInput'];
        if (advancedInput != null) {
          var advancedOutput = getAdvancedOutput(_actual!.solutions.first, advancedInput as String);
          expect(advancedOutput, elem['advancedOutput']);
        }
      });
    }
  });
