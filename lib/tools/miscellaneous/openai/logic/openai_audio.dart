...
Future<OpenAItaskOutput> _OpenAIgetAudioAsync(String APIkey, String model, String prompt, double temperature, String size, bool imageUrl, OPENAI_TASK task, {SendPort? sendAsyncPort}) async {
  String httpCode = '';
  String httpMessage = '';
  String textData = '';
  ...
  return OpenAItaskOutput(status: status, httpCode: httpCode, httpMessage: httpMessage, imageData: '', imageDataType: OPENAI_IMAGE_DATATYPE.NULL, textData: '');
}