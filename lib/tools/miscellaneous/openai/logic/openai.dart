...
class OPENAIgetChatJobData {
  ...
  final String openai_chat_model;
  final String openai_image_model;
  ...
  OPENAIgetChatJobData(
      ...
      required this.openai_chat_model,
      required this.openai_image_model,
...
final EMPTY_TASK_OUTPUT = OpenAItaskOutput(
    ...
    audioFile: GCWFile(bytes: Uint8List.fromList([])));

Future<OpenAItaskOutput> OpenAIrunTaskAsync(
  ...
  switch (ChatGPTgetChatJob.openai_task) {
    ...
    case OPENAI_TASK.SPEECH:
      output = await _OpenAIgetSpeechAsync(
          ...
          ChatGPTgetChatJob.openai_language,
          sendAsyncPort: jobData.sendAsyncPort);
      break;
    default:
      output = EMPTY_TASK_OUTPUT;
  }
