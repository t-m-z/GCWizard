...
class Zebra extends GCWWebStatefulWidget {
  Zebra({super.key}) : super(apiSpecification: _apiSpecification);
...
class _ZebraState extends State<Zebra> {
  ...
  String _buildOutput() {
    if (_currentMode == GCWSwitchPosition.left) {
      return encryptZebra(_currentInput, _currentOneTimePad);
    } else {
      return decryptZebra(_currentInput, _currentOneTimePad);
    }
  }
}
