...
class Juno extends GCWWebStatefulWidget {
  Juno({super.key}) : super(apiSpecification: _apiSpecification);

  @override
  _JunoState createState() => _JunoState();
}

class _JunoState extends State<Juno> {
  ...
  String _buildOutput() {
    if (_currentMode == GCWSwitchPosition.left) {
      return encryptJuno(_currentInput, _currentOneTimePad);
    } else {
      return decryptJuno(_currentInput, _currentOneTimePad);
    }
  }
}
