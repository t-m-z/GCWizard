...
class Grenztruppen535 extends GCWWebStatefulWidget {
  Grenztruppen535({super.key}) : super(apiSpecification: _apiSpecification);

  @override
  _Grenztruppen535State createState() => _Grenztruppen535State();
}

class _Grenztruppen535State extends State<Grenztruppen535> {
  ...
  String _buildOutput() {
    if (_currentMode == GCWSwitchPosition.left) {
      return encrypt535(_currentInput, _currentOneTimePad);
    } else {
      return decrypt535(_currentInput, _currentOneTimePad);
    }
  }
}
